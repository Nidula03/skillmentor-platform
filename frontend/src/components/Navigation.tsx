      ...
      {isSignedIn ? (
        ...
        <>
          ...
          <Link to="/login">
            <Button
              className={cn(
                "bg-[#4F6DF5] text-white hover:bg-[#3730a3] border-none",
                mobile && "w-full",
              )}
            >
              Sign up
      ...
      <div className="container flex flex-wrap h-14 items-center justify-between">
        <div className="flex items-center">
          <Link to="/" className="flex items-center space-x-2">
            ...
            />
            <span className="font-semibold text-xl text-white">SkillMentor</span>
          </Link>
              ...
              <div className="flex flex-col h-full">
                <div className="flex items-center justify-between mb-8">
                  ...
                  >
                    ...
                    />
                    <span className="font-semibold text-lg text-white">SkillMentor</span>
                  </Link>
                </div>
