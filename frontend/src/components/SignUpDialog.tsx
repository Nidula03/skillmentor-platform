      ...
      <DialogContent className="overflow-hidden p-0 border-none rounded-2xl max-w-[440px]">
        ...
        <div className="px-8 py-10 bg-white rounded-2xl">
          ...
          <Button
            ...
            className="w-full bg-[#4F6DF5] hover:bg-[#3730a3] text-white font-medium py-3 px-4 rounded-lg flex items-center justify-center space-x-2 transition-colors border-none"
          >
            <span>Sign up</span>
            <span>→</span>
          </Button>
