      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/40">
          <div className="mb-4 md:mb-0 flex items-center space-x-2">
            ...
            />
            <span className="font-black text-5xl bg-gradient-to-r from-[#6366f1] via-[#3b82f6] to-[#6366f1] bg-clip-text text-transparent animate-gradient-text">SkillMentor</span>
          </div>
          <p className="text-gray-400 text-sm">
            SkillMentor Inc. © Copyright 2026. All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>
